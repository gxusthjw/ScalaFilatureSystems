package cn.edu.gxust.jiweihuang.scala {
  ...
  package math {
    ...
    package object math {
      val DefaultNumericalPrecision: Double = 1e-15

    }

    package function.univariate {
      ...
      trait TUnivariateIntegrableFunction extends TUnivariateFunction {
        ...
        def integrateRomberg(lowerX: Double, upperX: Double, maxIter: Int = Int.MaxValue,
          ...
          new RombergIntegrator(relativeAccuracy, absoluteAccuracy, minimalIterationCount,
        ...
        def integrateSimpson(lowerX: Double, upperX: Double, maxIter: Int = Int.MaxValue,
          ...
          new SimpsonIntegrator(relativeAccuracy, absoluteAccuracy, minimalIterationCount,
            maximalIterationCount).integrate(maxIter, this, lowerX, upperX)
        ...
        def integrateMidPoint(lowerX: Double, upperX: Double, maxIter: Int = Int.MaxValue,
          ...
          new MidPointIntegrator(relativeAccuracy, absoluteAccuracy, minimalIterationCount,
            maximalIterationCount).integrate(maxIter, this, lowerX, upperX)
        ...
        def integrateIterativeLegendreGauss(lowerX: Double, upperX: Double, maxIter: Int = Int.MaxValue,
          ...
          new IterativeLegendreGaussIntegrator(integrationPointsNumber, relativeAccuracy,
            absoluteAccuracy, minimalIterationCount, maximalIterationCount).integrate(maxIter, this, lowerX, upperX)
      }
